<?php
  ...
  register_nav_menus( array(
    ...
    'beers' => 'Beer Page Tab Navigation Menu',
    'events' => 'Events Page Tab Navigation Menu'	
  ));
  ...
  function cartogram_scripts() {
    ...
    wp_register_script( 'app', get_template_directory_uri().'/dist/index.js', array(), false, true);
    wp_enqueue_script( 'app', array('jquery')  );

    // if(is_page('brew-finder')) {    wp_enqueue_script('index'); };
    ...
    wp_register_style( 'main', get_template_directory_uri().'/dist/index.css', '', '', '' );
